...
@Service
@CacheConfig(cacheNames = "something-two-with-key-generator")
public class SomeServiceTwoWithKeyGenerator {

    @Cacheable(keyGenerator = "collectionAndMapAwareKeyGenerator")
